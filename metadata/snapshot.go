...
func (inp *inProgress) store(key string) *broadCaster {
	bc := newBroadcaster()
...
type snapshotter struct {
	...
	db   *DB
	l    sync.RWMutex
	// inp holds all active extraction snapshots before becoming commited/removed. This can be used to wait on the
